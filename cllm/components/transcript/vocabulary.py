    ...
    def ACTION_TOKENS(self) -> dict[str, list[str]]:
        return {
            ...
            "ESCALATE": [
                ...
                "pass this along",
                "hand off",
                "bring to a supervisor",
                "submit to escalation",
                "report up",
                "send to higher support",
                "loop in",
                "raise to",
                "flag for review",
                "submit a ticket",
                "open escalation case",
                "send to escalation team",
                "escalate to engineering",
                "pass to technical team",
                "route to correct department",
                "handover to next level",
                "get my supervisor involved",
            ...
            "OFFER_DISCOUNT": [
                ...
                "limited-time offer",
                "apply customer retention discount",
                "waive fee",
                "apply voucher",
            ],
            "EDUCATE": [
