    ...
    EMOTION_KEYWORDS = {
        ...
        'ANGRY': {
            'keywords': [
                ...
                'infuriated', 'hate this', 'unacceptable', 'ridiculous', 'furious about'
            ],
            'intensity': 0.9
        },
        'DISAPPOINTED': {
            'keywords': [
                ...
                'unsatisfied', 'underwhelmed', 'bummed', 'disheartening', 'poor experience'
            ],
            'intensity': 0.7
        },
        'WORRIED': {
            'keywords': [
                ...
                'scared', 'fearful', 'uncertain', 'unsure', 'stressed about'
            ],
            'intensity': 0.6
        },
        'CONFUSED': {
            'keywords': [
                'confused', 'unclear', 'don’t understand', 'not sure', 'lost', 'bewildered',
                'unsure', 'don’t get it', 'need clarification', 'mixed up'
            ],
            'intensity': 0.5
        },
        'GRATEFUL': {
            'keywords': [
                'thank', 'thanks', 'thankful', 'appreciate', 'grateful', 'means a lot',
                'really helpful', 'much obliged', 'so kind', 'great support'
            ],
            'intensity': 0.6
        },
        'SATISFIED': {
            'keywords': [
                ...
                'excellent', 'awesome', 'amazing', 'fantastic', 'love it', 'delighted'
            ],
            'intensity': 0.8
        },
        'RELIEVED': {
            'keywords': [
                'relieved', 'finally', 'good to know', 'glad it’s fixed', 'that helps',
                'phew', 'thank goodness', 'much better now'
            ],
            'intensity': 0.6
        },
        'IMPATIENT': {
            'keywords': [
                'waiting too long', 'still waiting', 'hurry up', 'been waiting', 'slow response',
                'why is this taking', 'taking forever', 'long time'
            ],
            'intensity': 0.65
        },
        'HOPEFUL': {
            'keywords': [
                'hopeful', 'optimistic', 'looking forward', 'expecting', 'believe it’ll work',
                'trust it’ll be fine', 'can’t wait', 'excited to see'
            ],
            'intensity': 0.5
        },
        'CALM': {
            'keywords': [
                'calm', 'relaxed', 'fine', 'no rush', 'take your time', 'no worries',
        ...
        'APOLOGETIC': {
            'keywords': [
                'sorry', 'apologize', 'my bad', 'forgive me', 'I didn’t mean to', 'regret that',
                'please excuse', 'didn’t realize', 'won’t happen again'
            ],
            'intensity': 0.5
        },
        'GRATEFUL_POSITIVE': {
            'keywords': [
                'thank you so much', 'really appreciate it', 'you’ve been amazing',
                'incredible help', 'couldn’t have done it without you'
            ],
            'intensity': 0.7
        },
        'RESENTFUL': {
            'keywords': [
                'resent', 'fed up with', 'done with this', 'sick of dealing with', 'can’t stand',
                'this always happens', 'same issue again', 'every time'
            ],
            'intensity': 0.75
        },
        'SURPRISED': {
        ...
        'APATHETIC': {
            'keywords': [
                'whatever', 'doesn’t matter', 'I don’t care', 'meh', 'it’s fine',
                'not a big deal', 'whatever you say'
            ],
            'intensity': 0.3
        }
    }
