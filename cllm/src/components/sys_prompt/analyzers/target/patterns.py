...
TECHNICAL_CONCEPTS = [
    ...
    "cdn", "proxy servers", "firewalls", "nat", "bgp", "relational databases", "document databases",
    "graph databases", "time-series databases", "indexing", "query optimization", "acid", "event sourcing",
    "data warehousing", "etl", "data lakes", "caching", "redis", "elasticsearch",
    ...
    "domain-driven design", "clean architecture", "infrastructure as code", "terraform", "ansible", "jenkins",
    "cicd pipelines", "monitoring", "observability", "logging", "prometheus", "grafana",
...
CX_TECHNICAL_CONCEPTS = [
    ...
    "co-browsing", "screen sharing", "crm", "agent workspace", "unified agent desktop",
    ...
    "thin client environments", "gdpr", "ccpa", "data privacy", "pii masking", "data redaction",
