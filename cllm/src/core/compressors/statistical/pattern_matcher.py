...
class StatisticalCompressor:
    ...
    def compress(self, semantic_tokens: str, domain: str | None = None) -> tuple[str, dict]:
        """
        ...
        for match in reversed(selected_matches):
            ...
            compressed = (compressed[:match["start"]] +
                          ref_token + compressed[match["end"]:])
        ...
        metadata["additional_compression_ratio"] = (
            ...
            if metadata["original_tokens"] > 0 else 0.0
        )
