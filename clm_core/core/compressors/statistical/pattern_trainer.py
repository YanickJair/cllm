...
class StatisticalTrainer:
    ...
    def __init__(
        ...
        min_frequency: Annotated[
            int,
            Doc("Minimum number of corpus occurrences required to keep a mined pattern."),
        ] = 10,
    ...
    def train(
        ...
        valuable_patterns = [p for p in patterns if p.compression_gain >= self.min_compression_gain]
